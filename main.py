...
TENDERPLAN_WORDS = (
    'металлолом*,"лом","лома",(метал* отход*)~0,'
    'цветмет*,чермет*,Лом черных металлов,'
    'Лом цветных металлов,Прием лома,Реализация лома'
)
TENDERPLAN_EXCLUDED = (
    'канцеляр*,(продук* питан*)~0,(лом* пожарн*)~0,'
    '"ремонт",(ремонт* работ*)~1,шлифмашин*'
)
...
FORBIDDEN_PATTERNS: list[str] = [
    r"канцеляр", r"канцтовар", r"бумаг[аиу]",
    r"молок", r"мяс", r"рыб", r"овощ", r"фрукт",
    r"продукт[ыа] питан", r"хлеб", r"кондитер",
    r"медицин", r"лекарств", r"фармацевт",
    r"одежд", r"обув", r"мебел", r"посуд",
    r"хозтовар", r"хозяйствен", r"картридж", r"тонер",
    r"швабр", r"моющ", r"дезинфиц",
    r"ремонт дорог", r"ремонт помещ", r"ремонт здан",
    r"благоустройств", r"асфальт", r"страхован",
    r"клапан", r"шнур", r"водопровод", r"канализац",
    r"автомобил.{0,20}металлолом",  # продажа авто как металлолом
    r"металлолом.{0,30}автомобил",
    r"транспортн.{0,20}(утилизац|металлолом)",
    r"(грузов|легков|специальн).{0,20}(утилизац|металлолом)",
    r"капитальный ремонт",
    r"строительно-монтаж",
    r"дорожн.{0,10}работ",
    r"водоснабжен", r"водоотведен",
    r"теплоснабжен", r"теплосет",
...
GOOD_PATTERNS: list[str] = [
    ...
    r"чермет",
    r"цветмет",
    r"лом.{0,5}(3а|5а|12а|13а|15а|16а)",  # категории лома
]
